require("anyline").setup( {
    -- visual stuff
    indent_char = '|', -- character to use for the line default:▏
    highlight = 'IblIndent', -- color of non active indentation lines
    context_highlight = 'IblScope', -- color of the context under the cursor
